...
namespace home_library
{
    public class AdminLogic
    {
        ...
        // для проверки пароля с хэшем из бд
        public static bool VerifyHashedPassword(string hashedPassword, string password)
        {
            ...
            using (Rfc2898DeriveBytes bytes = new(password, dst, 0x3e8)) buffer4 = bytes.GetBytes(0x20);
        ...
        public static string HardCodedIncline(string state)
        {
            return state switch
            {
                "книга" => "книгу",
